...
function Liste_checken (Boardnamen: number[], Namen: string) {
    for (let Index = 0; Index <= Boardnamen.length; Index++) {
        for (let Index of Boardnamen) {
...
Boardnamen = []
Boardnamen.push(control.deviceName())
BoardnamenPosition = 0
programm = 0
kontrollbefehle(1)
farbendefinieren(1)
